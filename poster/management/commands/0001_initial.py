# Generated by Django 2.2.10 on 2020-03-11 23:08
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone_prim',
                 models.CharField(help_text='Enter primary phone number', max_length=32, verbose_name='Phone number')),
                ('phone_second', models.CharField(help_text='Enter secondary/additional phone number', max_length=32,
                                                  verbose_name='Phone number additional')),
                ...
                ('region', models.CharField(
                    choices=[('D', 'dolnośląskie'), ('C', 'kujawsko-pomorskie'), ('L', 'lubelskie'), ('F', 'lubuskie'),
                             ('E', 'łódzkie'), ('K', 'małopolskie'), ('W', 'mazowieckie'), ('O', 'opolskie'),
                             ('R', 'podkarpackie'), ('B', 'podlaskie'), ('G', 'pomorskie'), ('S', 'śląskie'),
                             ('T', 'świętokrzyskie'), ('N', 'warmińsko-mazurskie'), ('P', 'wielkopolskie'),
                             ('Z', 'zachodniopomorskie')], help_text='Choose region', max_length=1,
                    verbose_name='Region')),
