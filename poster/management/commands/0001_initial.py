# Generated by Django 2.2.10 on 2020-03-12 22:01
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone_second', models.CharField(help_text='Enter secondary/additional phone number', max_length=32, null=True, verbose_name='Phone number additional')),
                ('country', models.TextField(default='Poland', max_length=32)),
                ('region', models.CharField(choices=[('D', 'dolnośląskie'), ('C', 'kujawsko-pomorskie'), ('L', 'lubelskie'), ('F', 'lubuskie'), ('E', 'łódzkie'), ('K', 'małopolskie'), ('W', 'mazowieckie'), ('O', 'opolskie'), ('R', 'podkarpackie'), ('B', 'podlaskie'), ('G', 'pomorskie'), ('S', 'śląskie'), ('T', 'świętokrzyskie'), ('N', 'warmińsko-mazurskie'), ('P', 'wielkopolskie'), ('Z', 'zachodniopomorskie')], help_text='Choose region', max_length=1, verbose_name='Region')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.TextField(help_text='Fill photo description', max_length=64, null=True, verbose_name='Description')),
                ...
                ('file_name_origin', models.CharField(default='', max_length=64)),
                ('file_name_hashed', models.CharField(default='', max_length=64)),
                ('path_loaded', models.CharField(default='', max_length=256)),
                ('update_date', models.DateTimeField(auto_now=True)),
                ('creation_date', models.DateTimeField(auto_now_add=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('region', models.CharField(choices=[('D', 'dolnośląskie'), ('C', 'kujawsko-pomorskie'), ('L', 'lubelskie'), ('F', 'lubuskie'), ('E', 'łódzkie'), ('K', 'małopolskie'), ('W', 'mazowieckie'), ('O', 'opolskie'), ('R', 'podkarpackie'), ('B', 'podlaskie'), ('G', 'pomorskie'), ('S', 'śląskie'), ('T', 'świętokrzyskie'), ('N', 'warmińsko-mazurskie'), ('P', 'wielkopolskie'), ('Z', 'zachodniopomorskie')], help_text='Choose region', max_length=1, verbose_name='Region')),
                ('zip_code', models.TextField(help_text='Enter ZIP code', max_length=8, verbose_name='ZIP code')),
                ('street', models.TextField(default='', max_length=64, null=True)),
                ('active', models.BooleanField(default=True)),
                ('update_date', models.DateTimeField(auto_now=True)),
                ('creation_date', models.DateTimeField(auto_now_add=True)),
                ('categories', models.ManyToManyField(help_text='You can choose many categories', null=True, to='poster.Category', verbose_name='Categories')),
                ('photos', models.ManyToManyField(help_text='You can choose many photos', null=True, to='poster.Photo', verbose_name='Photos')),
